...
export const mockCandidates: AdminCandidate[] = [
  {
    ...
    categoryName: '投行观点',
    suggestedCategoryCode: 'investment_view',
    suggestedCategoryName: '投行观点',
    classificationConfidence: 0.96,
    classificationRule: 'KEYWORD_INVESTMENT_VIEW:goldman',
  ...
  },
  {
    ...
    categoryCode: 'macro',
    categoryName: '宏观政策',
    suggestedCategoryCode: 'macro',
    suggestedCategoryName: '宏观政策',
    classificationConfidence: 0.92,
    classificationRule: 'KEYWORD_MACRO:美联储',
    categoryOverrideReason: '',
  ...
  },
  {
    ...
    categoryCode: 'ai',
    categoryName: 'AI 前沿',
    suggestedCategoryCode: 'technology',
    suggestedCategoryName: '科技趋势',
    classificationConfidence: 0.88,
    classificationRule: 'KEYWORD_TECHNOLOGY:科技',
    categoryOverrideReason: '文章重点是 AI 应用落地，人工调整到 AI 前沿',
